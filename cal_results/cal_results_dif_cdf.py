...
def plot_cdfs(file_paths, names, colors, line_styles, save_plots=False):
    ...
    plt.xlabel('Computing time of satellites (s)')
    plt.ylabel('CDF')
    ...
    if save_plots:
        ...
        plt.savefig(f"./images/satellite_computing_time_CDF.pdf", format='pdf')
        plt.savefig(f"./images/satellite_computing_time_CDF.png", format='png')
    plt.show()
