...
def plot_data(folder_paths, names, colors, linestyles):
    ...
    trans_dict={'Average Ending Reward':'平均结束奖励',
    }
    ...
    plt.tight_layout()
    # plt.savefig(f"../images/training_CN_1.pdf", format='pdf')
    # plt.savefig(f"../images/training_CN_1.png", format='png')
    plt.savefig(f"../images/training_CN_2.pdf", format='pdf')
    plt.savefig(f"../images/training_CN_2.png", format='png')
    plt.show()

# colors = ['#7f7f7f', '#17becf', '#bcbd22', '#1f77b4', '#e377c2','#9467bd']
colors = ['#7f7f7f', '#17becf', '#1f77b4', '#e377c2','#9467bd','#bcbd22']
linestyles = [':' , '--', '-',  '-.', (0, (3, 5, 1, 5))]
# linestyles = ['--','-']
# folder_paths = ['../training_process_data/TCOM_version/train/train_WeakDQN.txt',"../training_process_data/TCOM_version/train/train_NewDDQN_dueling_shuffle.txt"]
# names = ['DQN','DDQN']
folder_paths = ['../training_process_data/TCOM_version/train/train_PureDDQN.txt','../training_process_data/TCOM_version/train/train_PureDDQN_dueling.txt','../training_process_data/TCOM_version/train/train_PurePPO_shuffle.txt',"../training_process_data/TCOM_version/train/train_NewDDQN_dueling_shuffle.txt"]
names = ['DDQN','D3QN','PPO','G-D3QN']
